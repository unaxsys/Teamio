...
## Промени:
- Добавих `status: response.status` във всички върнати обекти – полезно за логване и дебъгване.
- Запазих цялата оригинална логика – само надградих отговорите.

Препоръчвам да тестваш мрежови сценарии (502, timeout) преди deploy.// filepath: vscode-vfs://github%2B7b2276223a312c22726566223a7b2254797065223a342c226964223a22646576656c6f70227d7d/unaxsys/Teamio/web/app.js
...
Препоръчвам да тестваш мрежови сценарии (502, timeout) преди deploy.
  try {
    let { response, data } = await fetchJson(base);
